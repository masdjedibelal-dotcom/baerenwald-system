-- Bauprojekt-Flag (Lead → Auftrag) + ausführliche Bautagesberichte
...
comment on column public.leads.ist_bauprojekt is
  'Bauprojekt / Bauauftrag — erweiterte Unterlagen & Bautagesberichte';
comment on column public.auftraege.ist_bauprojekt is
  'Von Lead übernommen; steuert Bautagesbericht statt kurzem Bautagebuch';
...
comment on table public.auftrag_bautagesberichte is
  'Ausführlicher Bautagesbericht (Bauprojekte) inkl. PDF-Export';
