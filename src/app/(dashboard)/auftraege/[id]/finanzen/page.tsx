...
function addYearsFromToday(years: number): string {
  const d = new Date()
...
export default async function AuftragFinanzenPage({ params }: { params: { id: string } }) {
  ...
  const abweichung =
    hatEingang && margeEcht != null ? margeEcht - kalkMargeMitte : null
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-6">
      ...
      <AuftragFinanzenClient
        ...
        zuweisungen={hwRows}
        defaultFreigabeDatum={addYearsFromToday(5)}
        metrics={{
          kundenBrutto,
          kostenGesamt,
          margeEuro,
