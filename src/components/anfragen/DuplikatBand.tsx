...
export function DuplikatBand({
  ...
  useEffect(() => {
    if (!duplikatHinweis && !open) return
  ...
  if (!duplikatHinweis && kandidaten.length === 0 && !open) return null
      ...
      {!open ? (
        ...
        <div className="mt-2 space-y-2">
          ...
          <div className="flex gap-2">
            ...
            <button
              type="button"
              className="text-[length:var(--fs-meta)] underline"
