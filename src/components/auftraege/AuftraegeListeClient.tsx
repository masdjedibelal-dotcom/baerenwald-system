...
/** Nr. | Auftrag | Kunde | Betrag | Fortschritt | Lieferdatum | Status | Actions */
const AUFTRAGE_GRID_COLS = '100px 2fr 1.2fr 100px 1fr 110px 100px 60px'
          ...
          <ListGridShell minWidth="980px" className={cn('hidden md:block', isPane && 'min-[900px]:hidden')}>
            ...
            {listenGruppen.map((gruppe) => (
              <div key={gruppe.key} className="col-span-full space-y-1">
                ...
                {gruppe.items.map((a) => {
                  const abrechnungHinweis = pipelineHinweis(a)
                  const hatFortschritt = a.fortschritt != null && !Number.isNaN(Number(a.fortschritt))
                  const prog = hatFortschritt
                    ? Math.min(100, Math.max(0, Math.round(Number(a.fortschritt))))
                    : null
                  return (
                <div
                  key={a.id}
                ...
                >
                  ...
                  <div className="min-w-0">
                    <p className="list-row-primary truncate">{auftragTitel(a)}</p>
                  ...
                  <div>
                    {prog != null ? (
                      <div className={cn('prog', prog < 30 && prog > 0 && 'warn')}>
