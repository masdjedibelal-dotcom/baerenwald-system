  ...
  let meta = emptyAbnahmeProtokollMeta({
    ...
    ...(incoming
      ? {
          ...
          ohne_unterschrift: incoming.ohne_unterschrift,
          ohne_unterschrift_hw: incoming.ohne_unterschrift_hw,
          ohne_unterschrift_kunde: incoming.ohne_unterschrift_kunde,
      ...
      : previous
        ? {
            ...
            ohne_unterschrift: previous.ohne_unterschrift,
            ohne_unterschrift_hw: previous.ohne_unterschrift_hw,
            ohne_unterschrift_kunde: previous.ohne_unterschrift_kunde,
