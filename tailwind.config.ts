  ...
  theme: {
    extend: {
      colors: {
        ...
        warning: withAlpha('--status-offer-text'),
      ...
      fontSize: {
        /* 5-Stufen-Skala → CSS-Tokens (P5-19); Legacy xs/sm/… nur Bestand */
        'fs-caption': ['var(--fs-caption)', { lineHeight: '1.35' }],
        'fs-meta': ['var(--fs-meta)', { lineHeight: '1.4' }],
        'fs-text': ['var(--fs-text)', { lineHeight: '1.5' }],
        'fs-title': ['var(--fs-title)', { lineHeight: '1.4' }],
        'fs-head': ['var(--fs-head)', { lineHeight: '1.25' }],
        xs: ['var(--fs-meta)', { lineHeight: '1.4' }],
        sm: ['var(--fs-text)', { lineHeight: '1.5' }],
        base: ['var(--fs-text)', { lineHeight: '1.5' }],
        md: ['var(--fs-title)', { lineHeight: '1.5' }],
        lg: ['var(--fs-title)', { lineHeight: '1.4' }],
        xl: ['var(--fs-head)', { lineHeight: '1.3' }],
        '2xl': ['var(--fs-head)', { lineHeight: '1.2' }],
        chip: ['var(--fs-meta)', { lineHeight: '1.4' }],
      },
      spacing: {
        11: '44px',
        18: '72px',
      ...
      borderRadius: {
        /* Elementtyp-Tokens (P5-19) — bevorzugt gegenüber sm/md/lg */
        card: 'var(--r-card)',
        button: 'var(--r-button)',
        field: 'var(--r-field)',
        sheet: 'var(--r-sheet)',
